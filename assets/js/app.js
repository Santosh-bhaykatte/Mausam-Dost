    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        <ul class="meta-list">
            ...
            <li class="meta-item">
                ...
                <p class="title-3 meta-text">${module.getDate(dateUnix, timezone)}
                </p>
            </li>
        ...
        fetchData(url.airPollution(lat, lon), function (airPollution) {
            ...
            <div class="highlight-list">
                ...
                <div class="card card-sm highlight-card one">
                   ...
                   <h3 class="title-3">Air Quality Index
                </h3> 
         ...
         forecastSection.innerHTML = `
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                <div class="icon-wrapper">
                    <img src="./assets/images/weather_icons/${icon}.png" alt="${description}" class="weather-icon" title="${description}" width="36" height="36">
